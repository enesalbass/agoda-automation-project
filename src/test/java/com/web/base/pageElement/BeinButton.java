...
public class BeinButton extends PageElementModel {
    private static final Log log = LogFactory.getLog(BeinButton.class);


    public BeinButton(selectorNames selectorName, String selectorValue) {
