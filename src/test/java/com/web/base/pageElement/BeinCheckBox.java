...
public class BeinCheckBox extends PageElementModel {
    private static final Log log = LogFactory.getLog(BeinCheckBox.class);



    public BeinCheckBox(selectorNames selectorName, String selectorValue) {
